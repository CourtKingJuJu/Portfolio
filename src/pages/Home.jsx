        ...
        <div className='grid grid-cols-1 items-start gap-11 lg:grid-cols-[1.2fr_1fr]'>
          ...
          <div className='text-left'>
            ...
            <div className='mt-4 space-y-[14px] text-sm leading-relaxed text-zinc-400 sm:text-base sm:leading-[1.9]'>
              ...
              <p>
                Additionally, with my CS degree, I have completed a certificate
                in Data Science & a certificate in AI and Intelligent Systems at
                Dalhousie. I am very interested in ML & AI, specifically any
                intrinsically valuable application of the tool and its
                sustainability effects. I really enjoy hearing different
                perspectives about the topic in ethics, big tech, or just
                general discussion, and would love to hear what you think about
                it!
              </p>
